...
def test_add_article_with_article_already_in_basket_increases_quantity_of_that_article():
    ...
    article_to_add = create_article(
        product_name=article_in_basket.product.name,
        unit_price_before_taxes=article_in_basket.unit_price_before_taxes,
        imported=article_in_basket.imported,
...
def test_list_articles_returns_list_of_added_articles_sorted_by_insertion_order():
    articles_to_add = [
        create_article(quantity=1, product_name='B', unit_price_before_taxes=Decimal('1'), imported=True),
        create_article(quantity=1, product_name='A', unit_price_before_taxes=Decimal('1'), imported=True),
        create_article(quantity=1, product_name='B', unit_price_before_taxes=Decimal('1'), imported=True),
    ]
    expected = [
        create_article(quantity=2, product_name='B', unit_price_before_taxes=Decimal('1'), imported=True),
        create_article(quantity=1, product_name='A', unit_price_before_taxes=Decimal('1'), imported=True),
    ]
