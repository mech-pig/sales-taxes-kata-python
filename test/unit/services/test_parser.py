...
@pytest.mark.parametrize('text, quantity, product_name, unit_price, imported', [
    ...
    pytest.param('1 item imported with a log description! at 1.00', 1, 'item with a log description!', Decimal('1'), True, id='imported item (label in the middle)'),
    pytest.param('1 IMPORTED item with a log description! at 1.00', 1, 'item with a log description!', Decimal('1'), True, id='imported item (uppercase)'),
    pytest.param('1 item IMPORTED with a log description! at 1.00', 1, 'item with a log description!', Decimal('1'), True, id='imported item (uppercase, label in the middle)'),
    pytest.param('1 imported at 1.00', 1, '', Decimal('1'), True, id='imported only, no product name'),
